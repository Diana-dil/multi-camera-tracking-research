...
Текущая версия реализует **первый воспроизводимый baseline**: детекция людей YOLO11 и однокамерный трекинг с ByteTrack или BoT-SORT.
...
- NVIDIA GPU желателен, но можно запустить на CPU.
